            ...
            <div className="flex flex-col w-2/5 items-start">
                ...
                <div className="flex flex-col space-y-4 mt-6">
                    <div className="flex flex-row items-center space-x-2">
                        ...
                        <p className="text-xl font-rubik font-normal text-Charcoal">Trained to meet Industry Standard</p>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                        <img src={Icons.GreenTick} alt="GreenTick" />
                        <p className="text-xl font-rubik font-normal text-Charcoal">Independently pre-assessed</p>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                        <img src={Icons.GreenTick} alt="GreenTick" />
                        <p className="text-xl font-rubik font-normal text-Charcoal">Immediate Availability</p>
                    </div>
                    <div className="flex flex-row items-center space-x-2">
                        <img src={Icons.GreenTick} alt="GreenTick" />
                        <p className="text-xl font-rubik font-normal text-Charcoal">Hassle Free Experienc</p>
                    </div>
                </div>
