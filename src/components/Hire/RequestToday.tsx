        ...
        <div>
            ...
            <div className="hidden lg:flex flex-row justify-between bg-Alice_Blue rounded-lg mx-20 h-[278px]">
                <div className="flex flex-col w-[50%] items-start p-10">
                    ...
                    />
                    <button className="bg-Cobalt_Blue text-white font-sans font-medium text-lg items-center justify-center rounded-lg py-2 px-4 mt-4 flex flex-row">
            ...
            <div className="lg:hidden flex flex-col bg-Alice_Blue rounded-lg mx-4 p-4">
                ...
                <div className="flex flex-col items-center p-4">
                    ...
                    <button className="bg-Cobalt_Blue text-white font-sans font-medium text-base rounded-lg py-2 px-4 flex flex-row items-center">
                        Request Talent Today
                        <img
                            src={Icons.LeftArrow}
                            alt="left-arrow"
